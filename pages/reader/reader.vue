<template>
	<view class="Box" style="">
		...
		<!-- 小说正文结束 -->
		<!-- 目录 -->
		<view class="slider-mask" @click="maskClick" :class="{'slider-show-mask' :sliderShow}">
			<view @click.native.stop="sliderClick" class="slider-section" :class="{'slider-show-section' :sliderShow}">
...
<script>
	...
	import ssSliderbar from '../../components/ss-sliderbar/ss-sliderbar'
